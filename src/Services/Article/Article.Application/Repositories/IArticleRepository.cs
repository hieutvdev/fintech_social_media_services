...
public interface IArticleRepository
{
    ...
    Task<Domain.Models.Article> DetailAsync(string id, CancellationToken cancellationToken = default!);
    ...
    Task<IEnumerable<ArticleRelateResponseDto>> GetArticleRelateByIdAsync(string categoryNames, CancellationToken cancellationToken = default!);
